...
import { ActiveToggleDropdownItem, DeleteDropdownItem } from "@/components/DiscountCodeActions"
    ...
    return (
        <>
            <div className="flex justify-between items-center gap-4">
                ...
                <Button asChild>
                    <Link href="/admin/discount-codes/new">Add Product</Link>
                </Button>
            </div>
            <DiscountCodesTable discountCodes={activeCoupons} canDeactivate />

            <div className="mt-8">
                <h2 className="text-xl font-bold">Expired Coupons</h2>
                <DiscountCodesTable discountCodes={expiredCoupons} isInactive />
            </div>
        </>
    )
}
...
const DiscountCodesTable = ({
    ...
    discountCodes: Awaited<ReturnType<typeof getExpiredCoupons>>
    isInactive?: boolean
