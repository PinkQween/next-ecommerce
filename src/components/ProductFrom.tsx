...
export const ProductForm = ({ product }: { product?: Product | null }) => {
    const [price, setPrice] = useState<number | undefined>(product?.priceInCents !== undefined ? product?.priceInCents / 100 : undefined);
    ...
    return (
        <form action={action} className="space-y-8">
            ...
            <div className="space-y-2">
                ...
                <Input type="number" id="price" name="price" required value={price} onChange={e => { const inputValue = parseFloat(e.target.value); setPrice(Number(inputValue || 0)); }} />
